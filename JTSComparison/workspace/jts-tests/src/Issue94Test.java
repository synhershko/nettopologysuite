...
public class Issue94Test extends TestCase {
	...
	private static void performTest(double value) {
		...
		LineString ls1 = factory.createLineString(new Coordinate[] {
				new Coordinate(0, 0), new Coordinate(50, 50) });
		LineString ls2 = factory.createLineString(new Coordinate[] {
				new Coordinate(10, value), new Coordinate(10, -value) });
